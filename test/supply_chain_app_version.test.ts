...
import { supplyChainAppVersion } from '../src/supply_chain_app_version';

// GENERATED BY gg_version WriteVersionFile - DO NOT EDIT.
//
// Repairs the version literal in
// src/supply_chain_app_version.ts
...
describe('supply_chain_app_version.ts', () => {
  it('matches the version in package.json', () => {
    ...
    const path = 'src/supply_chain_app_version.ts';
    ...
    expect(supplyChainAppVersion).toBeTruthy();
  });
});
